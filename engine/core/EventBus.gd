...
signal battle_actor_turn_started(actor_id: String)
signal battle_move_hit(target_id: String, move_type: int)
signal battle_condition_applied(actor_id: String, condition_id: String)
