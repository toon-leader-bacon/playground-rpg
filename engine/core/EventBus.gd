...
signal zone_player_moved(new_pos: Vector2i)
signal zone_tile_effect_triggered(effect_tag: String, actor_id: String)
signal zone_encounter_triggered(monster_id: String, level: int)
signal zone_entity_interacted(entity_id: String, effect_tag: String)
signal zone_warp_requested(zone_id: String, spawn_point_id: String)
signal zone_flag_set(flag_key: String, flag_value: Variant)
signal zone_message_shown(text: String)
